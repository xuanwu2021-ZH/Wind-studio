...
describe('isAppRendererUrl', () => {
  ...
  it('trusts a packaged app page when the launch path reaches the app through a directory link', () => {
    ...
    const appRootFromLaunchPath = join(linkedProgramsDir, 'Windbot Studio', 'resources', 'app.asar')
    const realAppRoot = join(realProgramsDir, 'Windbot Studio', 'resources', 'app.asar')
