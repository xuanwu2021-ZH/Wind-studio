...
describe('privacy policy resource selection', () => {
  ...
  it('builds a Windows-safe dark theme file URL', () => {
    expect(buildPrivacyPolicyUrl('C:\\Program Files\\Wind Studio\\resources', 'zh-TW', ThemeMode.dark)).toBe(
...
describe('PrivacyPolicyDialog', () => {
  beforeEach(() => {
    ...
    mocks.ipcRequest.mockResolvedValue({ resourcesPath: '/Applications/Wind Studio.app/Contents/Resources' })
  })
