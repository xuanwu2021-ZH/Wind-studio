...
import OnboardingPage, { __testSetOnboardingDefaultStep } from '../OnboardingPage'
...
describe('OnboardingPage', () => {
  beforeEach(() => {
    // Tests were written for the original welcome-first behaviour. Reset the
    // production default back to 'welcome' so the suite keeps exercising the
    // CherryIN-OAuth-first path it was designed for. Production never calls
    // __testSetOnboardingDefaultStep.
    __testSetOnboardingDefaultStep('welcome')
    vi.clearAllMocks()
  ...
  it('uses an elevated welcome layout with clear text hierarchy and intentional spacing', () => {
    ...
    const logo = screen.getByRole('img', { name: 'Windbot Studio' })
