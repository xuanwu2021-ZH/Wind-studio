...
/** True when a model entry was injected by Windbot Studio (its `envKey` starts with `CHERRY_`). */
...
/** Find the provider key Windbot Studio manages (prefixed with `CHERRY_PROVIDER_PREFIX`). */
