# Wind Studio Design System

This document defines Wind Studio's product-wide visual direction and the rules for choosing shared design
...
Wind Studio is a content-first AI workspace. The interface should feel calm, precise, and utilitarian so that
