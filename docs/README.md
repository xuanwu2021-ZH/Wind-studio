...
| Document | Description |
|----------|-------------|
| [Data System Reference](./references/data/README.md) | Entry point for Wind Studio data systems - decision guide across BootConfig, Cache, Preference, DataApi, app_state |
...
| Document | Description |
|----------|-------------|
| [Wind Studio LAN Transfer Protocol Specification](./references/lan-transfer/README.md) | LAN transfer protocol spec for desktop-mobile sync covering mDNS discovery, TCP handshake, and file transfer |
