...
export const Bordered: Story = {
  ...
  render: () => (
    <div className="w-[420px] rounded-xl border border-border bg-background">
      ...
      />
      <div className="px-5 py-4 text-foreground-tertiary text-sm">Detail body content sits below the divider.</div>
    </div>
  )
}
